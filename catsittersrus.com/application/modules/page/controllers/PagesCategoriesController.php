...
class Page_PageCatergoriesController extends Zend_Controller_Action
{
    public $albums;
    public $files;
    public $auth;
...
//         $file_id =1;
//         $fileTable = new Page_Model_Files();
